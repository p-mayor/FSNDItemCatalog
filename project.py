...
def deleteRestaurant(restaurant_id):
  ...
  if restaurantToDelete.user_id != login_session['user_id']:
    ...
    restaurant. Please create your own restaurant to delete.');}</script><body onload='myFunction()''>"
  if request.method == 'POST':
...
def newMenuItem(restaurant_id):
  ...
  if login_session['user_id'] != restaurant.user_id:
        ...
        items to this restaurant. Please create your own restaurant in order to add items.\
        ');}</script><body onload='myFunction()''>"
  if request.method == 'POST':
...
def deleteMenuItem(restaurant_id,menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        ...
        items to this restaurant. Please create your own restaurant in order to delete items.\
        ');}</script><body onload='myFunction()''>"
    if request.method == 'POST':
